        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class=" col-12 col-sm-12 col-md-6 col-lg-6 col col-xl-6 col-xxl-6" id="second_img">
                    <div
                        class="container"style="width: 42%;height: 33%;position: relative;overflow: hidden;margin-left: 66px">
                        <iframe src="https://embed.lottiefiles.com/animation/49514" width="70%" height="70%"
                            style="border:none;">
                        </iframe>
                    </div>
                    ...
                    <div class="copyright">
                        <p>
                        <h2>copyright@ 2023 all right reserved <br>
                            ...
                            <a href="https://therevolutiontechnologies.com/" target="__blank">The Revolution Technologies
                        </h2></a></p>
