        ...
        <div class="bg-white rounded p-2">
            ...
            <div class="d-flex m-2" style="width: 100%">
                <div class="row"style="width:103%;margin-left:-18px">
                    <div class="col-lg-3 col-md-3 order-sm-12 col-12" value="{{ @$state }}" id="1"
                        tab="Booked" onclick="fetchCustomers(this.id)"style="margin-top: 10px;">
                    ...
                    <div class="col-lg-3 col-md-3 order-sm-12 col-12" value="{{ @$state }}" id="2"
                        tab="Shipped" onclick="fetchCustomers(this.id)" style="margin-top: 10px;margin-left:-21px">
                    ...
                    <div class="col-lg-3 col-md-3 order-sm-12 col-12" value="{{ @$state }}" id="3"
                        tab="Arrived" onclick="fetchCustomers(this.id)" style="margin-top: 10px;margin-left:9px">
                    ...
                    <div class="col-lg-3 col-md-3 order-sm-12 col-12" value="{{ @$state }}" id="4"
                        tab="Completed" onclick="fetchCustomers(this.id)" style="margin-top: 10px;margin-left:-11px;">
                    ...
                    <div class="px-4 pt-2 mt-4">
                        ...
                        ">
                                        ...
                                        <input type="date"
                                            ...
                                            id="loading_date" aria-describedby="loading_date"
                                            style="height: 31px!important;" required>
                                    </div>
                        ...
                        ">
                                        ...
                                        <input type="date"
                                            class="form-control-sm border-style shipment_filtering col-7 text-muted px-2"
                                            id="arrival_date" aria-describedby="arrival_date"
                                            style="height: 31px!important;" required>
                                    </div>
                                </div>
                                <div class="col-md-3 col-lg-3 col-sm-12 p-0">
