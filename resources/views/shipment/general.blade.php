        ...
        <div class="bg-white">
            ...
            <div class="mt-3">
                <div class="col-12 d-flex justify-content-end">
                    <input type="text" style="outline:none!important;font-size:13px!important;color:gray!important"
                        id="shipment_search" name="shipment_search" onkeyup="search_shipment()" placeholder="Search VIN">
                </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <select
                                                        ...
                                                        @if (@$shipment[0]['shipment_type'])
                                                            <option value="{{ @$shipment[0]['shipment_type'] }}"
                                                                selected disabled>{{ @$shipment[0]['shipment_type'] }}
                                                            </option>
                                                        @else
                                            ...
                                            <div class="col-12 py-2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <input type="date"
                                                        ...
                                                        value="{{ @$shipment[0]['est_arrival_date'] }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <select
                                                        ...
                                                        @if (@$shipment[0]['container_size'])
                                                            <option value="{{ @$shipment[0]['container_size'] }}">
                                                                {{ @$shipment[0]['container_size'] }}</option>
                                                        @else
                                                            <option selected disabled>Select Container Size</option>
                                                        @endif
                                                        @foreach ($container_size as $Csize)
                                                            <option value="{{ @$Csize['name'] }}">
                                                                {{ @$Csize['name'] }}</option>
                                                        @endforeach
                                                    </select>
                                                    {{-- <input type="text"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <select
                                                        ...
                                                        @if (@$shipment[0]['container_type'])
                                                            <option value="{{ @$shipment[0]['container_type'] }}">
                                                                {{ @$shipment[0]['container_type'] }}</option>
                                                        @else
                                                            <option selected disabled>Select Container Type</option>
                                                        @endif
                                                        @foreach ($container_types as $Ctype)
                                                            <option value="{{ @$Ctype['name'] }}">
                                                                {{ @$Ctype['name'] }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-12 py-2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ @$shipment[0]['shipping_reference'] }}">
                                                </div>
                                            </div>
                                            <div class="col-12 py-2">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <div id="shipment_loading_body">
                                            ...
                                            <div class="col-12 py-2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <select name="loading_country" id="loading_country"
                                                        class="form-control-sm border border-0 rounded-pill bg col-6"
                                                        onchange="FetchState()">
                                                        @if (@$shipment[0]['loading_country'])
                                                            <option value="{{ @$shipment[0]['loading_country'] }}"
                                                                selected disabled>
                                                                {{ @$shipment[0]['loading_country'] }}</option>
                                                        @else
                                            ...
                                            <div class="col-12 py-2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <select name="loading_state" id="loading_state"
                                                        class="form-control-sm border border-0 rounded-pill bg col-6"
                                                        onchange="FetchPort()">
                                                        @if (@$shipment[0]['loading_state'])
                                                            <option value="{{ @$shipment[0]['loading_state'] }}"
                                                                selected disabled>{{ @$shipment[0]['loading_state'] }}
                                                            </option>
                                                        @else
                                            ...
                                            <div class="col-12 py-2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <select
                                                        class="form-control-sm border border-0 rounded-pill bg col-6"
                                                        name="loading_port" id="loading_port"
                                                        onchange="FetchTerminal()">
                                                        @if (@$shipment[0]['loading_port'])
                                                            <option value="{{ @$shipment[0]['loading_port'] }}"
                                                                selected disabled>{{ @$shipment[0]['loading_port'] }}
                                                            </option>
                                                        @else
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <select
                                                        ...
                                                        @if (@$shipment[0]['loading_terminal'])
                                                            <option value="{{ @$shipment[0]['loading_terminal'] }}"
                                                                selected disabled>
                                                                {{ @$shipment[0]['loading_terminal'] }}</option>
                                                        @else
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <select
                                                        ...
                                                        @if (@$shipment[0]['destination_country'])
                                                            <option value="{{ @$shipment[0]['destination_country'] }}"
                                                                selected disabled>
                                                                {{ @$shipment[0]['destination_country'] }}</option>
                                                        @else
                                                            <option selected disabled>Select Destination Country
                                                            </option>
                                                        @endif
                                                        @foreach ($destination_country as $dcountry)
                                                            <option value="{{ @$dcountry['country'] }}">
                                                                {{ @$dcountry['country'] }}</option>
                                                        @endforeach
                                                    </select>
                                                    {{-- <input type="text"
                                                        class="form-control-sm border border-0 rounded-pill bg col-6"
                                            ...
                                            <div class="col-12 py-2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <select
                                                        ...
                                                        onchange="FetachDestinationPort()">
                                                        @if (@$shipment[0]['destination_state'])
                                                            <option value="{{ @$shipment[0]['destination_state'] }}"
                                                                selected disabled>
                                                                {{ @$shipment[0]['destination_state'] }}</option>
                                                        @else
                                                            <option selected disabled>Select State</option>
                                                        @endif
                                            ...
                                            <div class="col-12 py-2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <select
                                                        ...
                                                        onchange="FetchDestiTerimals()">
                                                        @if (@$shipment[0]['destination_port'])
                                                            <option value="{{ @$shipment[0]['destination_port'] }}"
                                                                selected disabled>
                                                                {{ @$shipment[0]['destination_port'] }}</option>
                                                        @else
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <select
                                                        ...
                                                        @if (@$shipment[0]['destination_terminal'])
                                                            <option
                                                                value="{{ @$shipment[0]['destination_terminal'] }}"
                                                                selected disabled>
                                                                {{ @$shipment[0]['destination_terminal'] }}</option>
                                                        @else
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <select
                                                        ...
                                                        @if (@$shipment[0]['shipping_line'])
                                                            <option value="{{ @$shipment[0]['shipping_line'] }}"
                                                                selected disabled>{{ @$shipment[0]['shipping_line'] }}
                                                            </option>
                                                        @else
                                                            <option selected disabled>Select Shipping Line</option>
                                                        @endif
                                                        @foreach ($shipment_lines as $Slines)
                                                            <option value="{{ @$Slines['name'] }}">
                                                                {{ @$Slines['name'] }}</option>
                                                        @endforeach
                                            ...
                                            <div class="col-12 py-2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ @$shipment[0]['fmc_license_number'] }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div id="note_body">
                                            <div class="col-12 py-2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <textarea type="text" class="form-control-sm border border-0 col-6 card-pill" name="notes" id="notes"
                                                        value="{{ @$shipment[0]['notes'] }}">{{ @$shipment[0]['notes'] }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="d-flex justify-content-end col-6">
                            @if (@$shipment[0]['id'])
                                <div class="col-3">
                                    ...
                                    <button type="button" class="btn next-style text-white col-12 py-1"
                                        onclick="save_shipment_form(this.id)" id="general_shipment"
