                ...
                @foreach ($recordlist as $data)
                    <tr>
                        ...
                        <td style="text-center">
                            <input class="form-check-input status_change" id="{{ $data['id'] }}" tab="{{ @$tab }}"
                                {{ $data['status'] == 1 ? 'checked' : '' }} type="checkbox" value="{{ $data['status'] }}">
                            <input type="hidden" value="{{ $data['id'] }}" class="current_id">
                            <button class="edit-button" id="{{ $data['id'] }}" onclick="updatemaster(this.id,this.value)"
                                value="{{ @$value }}" style="cursor: pointer !important;">
