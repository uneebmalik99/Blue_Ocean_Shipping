        ...
        <div class="bg-white rounded p-2">
            ...
            <div class="d-flex m-2">
                <div class="row" style="width: 100%;margin-left: 2px">
                    <div class="col-md-4 col-lg-4 col-sm-12 p-1" value="{{ @$state }}" id="1" tab="New Order"
                        onclick="fetchVehicles(this.id)" style="cursor: pointer">
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-12 p-1" value="{{ @$state }}" id="2" tab="Dispatched"
                        onclick="fetchVehicles(this.id)" style="cursor:pointer">
                        <div class="col-12 py-0 px-1">
                            <div class="col-12 border-style card-rounded py-2 px-3">
                                <div class="d-flex">
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-12 p-1" value="{{ @$state }}" id="3" tab="On Hand"
                        onclick="fetchVehicles(this.id)" style="cursor: pointer;">
                        <div class="col-12 py-0 px-1">
                            <div class="col-12 border-style card-rounded py-2 px-3">
                                <div class="d-flex">
            ...
            <div class="d-flex m-2">
                <div class="row" style="width: 100%;margin-left: 2px">
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-12 p-1" value="{{ @$state }}" id="4"
                        tab="No Title" onclick="fetchVehicles(this.id)" style="cursor:pointer;">
                        <div class="col-12 py-0 px-1">
                            <div class="col-12 border-style card-rounded py-2 px-3">
                                <div class="d-flex">
                                    <div class="col-10 text-muted p-0 d-flex align-items-center">
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-12 p-1" value="{{ @$state }}" id="5"
                        tab="Towing" style="cursor:pointer;">
                        <div class="col-12 py-0 px-1">
                            <div class="col-12 border-style card-rounded py-2 px-3">
                                <div class="d-flex">
                                    <div class="col-10 text-muted p-0 d-flex align-items-center">
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-12 p-1" value="{{ @$state }}" id="6"
                        tab="Inventory Value" onclick="fetchVehicles(this.id)" style="cursor:pointer;">
                        <div class="col-12 py-0 px-1">
                            <div class="col-12 border-style card-rounded py-2 px-3">
                                <div class="d-flex">
                                    <div class="col-10 text-muted p-0 d-flex align-items-center">
                            ...
                            <tbody class="bg-white font-size" id="vehicle_tbody">
                                ...
                                @foreach ($records as $val)
                                    <tr>
                                        @role(['Super Admin', 'Sub Admin'])
                                            <td>
                                                <input type="checkbox" name="checkboxes" id="{{ @$val['id'] }}"
                                                    title="Add" onchange="addtoShipment(this.id)"
                                                    {{ @$val['shipment_status'] == 1 ? 'checked' : '' }}>
                                            </td>
                                        @endrole
                                        <td>
