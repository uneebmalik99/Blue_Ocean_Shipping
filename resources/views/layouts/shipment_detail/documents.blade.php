        ...
        <div class="information_second_div">
            <div class="row" style="padding-bottom:60px">
                ...
                <div class="col-sm-12 col-md-7 col-lg-5 mb-4 mt-5">
                    ...
                    <div class="  information_gallary image_section col-10 col-sm-10 col-md-10 col-lg-10 order-xl-10  mx-auto"
...
<div id="modal01" class="imagemodal" style="z-index: 999999999999!important;" onclick="this.style.display='none'">
