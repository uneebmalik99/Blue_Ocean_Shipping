    ...
    <div id="thissection">
            ...
            <table class="tbl_0" style="width:100%;border:none;">
                <tbody>
                    <tr>
                        ...
                        <td class="t_data"><input type="text" value="BILL OF LADING" style="width: 20%;border:none;outline:none;text-align:start;font-weight:bold;margin-left:225px!important; text-decoration:underline rgb(133, 125, 125)"></td>
                    </tr>
            ...
            <table class="table_3" style="width:100%;margin-top: 12px!important">
                <tbody>
                    <tr>
                        ...
                        <td class="td3_data"><input type="text" value="REFERENCE #" style="width: 100%;border:none;outline:none;text-align:start;font-weight:bold"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="td3_data"><input type="text" value="PORT OF DISCHARGE:" style="width: 100%;font-weight:bold; border:none;outline:none;text-align:start;weight:bold"></td>
            ...
            <table class="table_3" style="width:100%;margin-top: -6px">
                <tbody>
                    <tr>
                        ...
                        <td class="td3_data"><input type="text" value="VESSEL #" style="width: 100%;border:none;outline:none;text-align:start;font-weight:bold"></td>
                    </tr>
                    <tr>
                        <td rowspan="4" class="td3_data">
                    ...
                    <tr>
                        ...
                        <td class="td3_data"><input type="text" value="VOYAGE NO." style="width: 100%;border:none;outline:none;text-align:start;font-weight:bold"></td>
                    </tr>
                    <tr>
                <td class="td3_data"><input type="text" value="{{ @$shipment[0]['loading_terminal'] }}" style="width: 100%;border:none;outline:none;text-align:start;"></td>
        ...
        <div class="tbl_3">
            <table class="table_3" style="width:100%;margin-top: -6px">
                <tbody>
                    <tr>
                        <td colspan="1" class="td3_p"><input type="text" value="NOTIFY" style="width: 100%;border:none;outline:none;text-align:start;font-weight:bold"></td>
            ...
            <table class="table_3" style="width:100%;margin-top: -6px">
                <tbody>
                    <tr>
                        ...
                        <td class="td3_data"><input type="text" value="SPECIAL INSTRUCTIONS" style="width: 100%;border:none;outline:none;text-align:start;font-weight:bold"></td>
                    </tr>
                    <tr>
            ...
            <table class="table_3" style="width:100%;margin-top: -6px">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td3_data"style="border:none"><input type="text" value="--" style="width: 100%;border:none;outline:none;text-align:start;"></td>
                        <td class="td3_data" style="background-color:#e6e2e2;"><input type="text" value="55 M3" style="width: 100%;border:none;outline:none;text-align:start;background-color:#e6e2e2;"></td>
            ...
            <table class="table_3" style="width:100%;margin-top: -6px">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td3_data"><input type="text" value="WEIGHT(KG)" style="width: 100%;border:none;outline:none;text-align:start;font-weight:bold"></td>
                    ...
                    <tr>
                        <td colspan="4" class="p_text"><input type="text" value="These Comodities, Technology Or Software Were Exported From The United States In The Acordance With The Exoirt." style="width: 100%;border:none;outline:none;text-align:start;"></td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="tbl_3">
            <table class="table_3" style="width:100%;margin-top: -6px">
                <tbody>
                    ...
                    <tr>
                        <td colspan="1" class="td3_data" style="border: none"><input type="text" value="AUTHORIZED:" style="width: 100%;border:none;outline:none;text-align:start;font-weight:bold"></td>
                        <td id="text_w" colspan="1" class="td3_data"style="border: none;background-color:#e6e2e2;"></td>
                        <td colspan="1" class="td3_data"style="border: none"><input type="text" value="DATED AT:" style="width: 100%;border:none;outline:none;text-align:start;font-weight:bold"></td>
                        <td  colspan="1" id="text_w" class="td3_data"style="border: none;background-color:#e6e2e2"></td>
                    </tr>
                </tbody>
            </table>
        </div>
