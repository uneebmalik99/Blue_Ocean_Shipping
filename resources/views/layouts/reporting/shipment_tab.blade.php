<div class="border-style card-rounded">
    ...
    <div class="shipment_table_body" style="overflow: scroll">
        <table id="shipment_reporting" class="table row-border shipment-reporting" style="width:100%!important;">
...
<script type="text/javascript">
    function filter_shipment_reporting() {
        ...
        function format(d) {
            html = '<table class="vehicle_shipment_table my-3" style="width:90%!important;"><thead style="background:#dbdbdb;color:#2c3e50;font-size:12px!important;"><th>ID</th><th>Customer Name</th><th>VIN</th><th>YEAR</th><th>MAKE</th><th>MODEL</th><th>VEHICLE TYPE</th><th>VALUE</th><th>Action</th></thead><tbody id="shipemt_vehicle">';
            d.forEach(element => {
        ...
        $('.shipment-reporting tbody').on('click', 'td.dt-control', function() {
    ...
    function cleardatatables() {
        $('.shipment-reporting').DataTable().clear().destroy();
    }
