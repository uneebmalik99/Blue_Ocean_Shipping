    ...
    <div class="container">
        <div class="row">
            <div class="col-12 d-flex justify-content-end">
                <button class="share_button" style="" onclick="copyToClipboard()"><svg width="8"
                        height="10" viewBox="0 0 8 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
        ...
        <div class="row">
            <div class="d-flex justify-content-between w-100">
                <button id="warehouse" class="btn active" style="width:33%">Warehouse Images</button>
                <button id="auction" class="btn" style="width:33%">Auction Images</button>
        ...
        <div class="row">
            <div class="col-12 d-flex justify-content-end">
                <button class="share_button downloadVehicles_zip" id="warehouse_images" style=""
