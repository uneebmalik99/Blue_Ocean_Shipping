...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="images_vehicle d-flex flex-wrap justify-content-between" style="background: rgba(243, 243, 243, 0.72);
            box-shadow: 3px 4px 3px rgba(22, 22, 22, 0.24);
