...
<form method="POST" id="customer_shipper_form" enctype="multipart/form-data">
        ...
        <div id="shipper_div"
                ...
                <div class="col-4 d-block">
                    ...
                    <div>
                        <input type="text" class="form-control-sm border border-0 rounded-pill bg col-8"
                            name="shipper_name[]" id="shipper_name" value="{{ @$shipper['shipper_name'] }}">
                    </div>
                </div>
                <div class="col-4 d-block">
                    <div>
                    ...
                    <div>
                        <input type="text" class="form-control-sm border border-0 rounded-pill bg col-8"
                            ...
                            value="{{ @$shipper['contact_person_name'] }}">
                    </div>
                </div>
                <div class="col-4 d-block">
                    <div>
                    ...
                    <div>
                        <input type="text" class="form-control-sm border border-0 rounded-pill bg col-8"
                            name="phone[]" id="phone" value="{{ @$shipper['phone'] }}">
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-around p-2">
                <div class="col-4 d-block">
                    ...
                    <div>
                        <input type="text" class="form-control-sm border border-0 rounded-pill bg col-8"
                            name="company_email[]" id="company_email" value="{{ @$shipper['company_email'] }}">
                    </div>
                </div>
                <div class="col-4 d-block">
                    <div>
                    ...
                    <div>
                        <input type="text" class="form-control-sm border border-0 rounded-pill bg col-8"
                            name="country[]" id="country" value="{{ @$shipper['country'] }}">
                    </div>
                </div>
                <div class="col-4 d-block">
                    <div>
                    ...
                    <div>
                        <input type="text" class="form-control-sm border border-0 rounded-pill bg col-8"
                            name="city[]" id="city" value="{{ @$shipper['city'] }}">
                    </div>
                </div>
            </div>
                ...
                <div class="col-4 d-block">
                    ...
                    <div>
                        <input class="form-control-sm border border-0 rounded-pill bg col-8" type="text"
                            name="zip_code[]" id="zip_code" value="{{ @$shipper['zip_code'] }}">
                    </div>
                </div>
                <div class="col-4 d-block">
                    <div>
                    ...
                    <div>
                        <input class="form-control-sm border border-0 rounded-pill bg col-8" type="text"
                            name="address[]" id="address" value="{{ @$shipper['address'] }}">
                    </div>
                </div>
    ...
    <button type="button" onclick="addShipper()" class="btn btn-info">Add</button>
    ...
    <div class="col-12 py-2 px-5 d-flex justify-content-end">
        ...
        @if (!@$shipper[0]['id'])
            <button type="button" class="btn next-style text-white col-1 py-1 mx-2" style="cursor:pointer;"
                onclick="skip_view(this.id)" id="skip" currenttab="shipper_customer" nexttab="quotation"
                skiptab="quotation_customer_tab">
...
<script>
    //     function addShipper() {
    //   var shipperDiv = document.getElementById('shipper_div');
    //   var clonedDiv = shipperDiv.cloneNode(true);
    //   clonedDiv.style.marginTop = '20px'; // Set margin-top for the cloned div
    //   var inputs = clonedDiv.querySelectorAll('input');
    //   inputs.forEach(function(input) {
    //     input.value = '';
    //   });
    //   shipperDiv.parentNode.insertBefore(clonedDiv, document.getElementById('add_shipper_customer').parentNode);
    // }
    function addShipper() {
        $.ajax({
                type: 'get',
                url: '{{ route('customers.addShipper') }}',
                success: function(data) {
                    $('#shipper_container').append(data);
