...
class VehicleController extends Controller
{
    ...
    public function index()
    {
        ...
        if(Auth::user()->hasRole('Customer')){
            ...
            $data['no_titles'] = Vehicle::where('added_by_user', auth()->user()->id)->orwhere('customer_name', auth()->user()->id)->where('title_type', '!=', 'Exportable')->orwhereNull('title_type')->get();
    ...
    public function profile($id)
    {
        ...
        $data = [
            'vehicle' => Vehicle::with(['user','pickupimages', 'warehouse_image', 'vehicle_status', 'billofsales'])->find($id)->toArray(),
